<template>
    <div>
        <p>Form 6: 自定义校验: validate-status, has-feedback, help</p>
        <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
            ...
            <a-form-item label="Validating" has-feedback validate-status="validating"
            ...
            <a-form-item label="Fail" has-feedback validate-status="error"
